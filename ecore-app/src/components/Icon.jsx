const PATHS = {
  ...
  chart: "M3 3v18h18 M7 13h3v5H7z M12 9h3v9h-3z M17 6h3v12h-3z",
  alert: "M12 9v4M12 17h.01M10.3 3.9L2.8 17a2 2 0 0 0 1.7 3h15a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z",
...
export default function Icon({ name, color = "currentColor", size = 18, className = "" }) {
  const d = PATHS[name] || "";
